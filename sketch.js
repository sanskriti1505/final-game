...
var bar18, bar19, bar20, bar22,bar23,bar24,bar25,bar26,bar21;
var bar27, bar28, bar29, bar30, bar31,bar32,bar33,bar34,bar35,bar36;
var edges;
var gamestate=0;
...
player1Img=loadImage("red.png")
player2Img=loadImage("green.jfif")
player3Img=loadImage("blue.jfif")
player4Img=loadImage("yellow.jfif")
}
function setup(){
  ...
  bar5.shapeColor="red";
  bar6=createSprite(700,550,10,200)
  ...
  bar21=createSprite(900,480,200,10)
  bar21.shapeColor="red";
  bar27=createSprite(79,233,100,10,200)
  bar27.shapeColor="green";
  bar28=createSprite(155,350,10,140)
  bar28.shapeColor="yellow";
  bar29=createSprite(432,500,10,150)
  bar29.shapeColor="red";
  bar30=createSprite(687,256,10,150)
  ...
  bar32=createSprite(441,508,110,10);
  bar32.shapeColor="blue";
  bar33=createSprite(172,350,110,10);
  bar33.shapeColor="green";
  bar34=createSprite(594,365,110,10);
  bar34.shapeColor="yellow";
  bar35=createSprite(600,865,110,10);
  bar35.shapeColor="red";
  bar36=createSprite(740,210,110,10)
  bar36.shapeColor="blue";
  portal1=createSprite(253,459,110,10)
  ...
  grp1.addImage(player1Img);
  grp1.scale=0.5;
  grp2=createSprite(400,400,50,50);
  grp2.addImage(player2Img);
  grp2.scale=0.5;
  grp3=createSprite(600,400,50,50);
  grp3.addImage(player3Img);
  grp3.scale=0.5;
  grp4=createSprite(800,400,50,50);
  grp4.addImage(player4Img);
  grp4.scale=0.5;
 player=createSprite(100,100,50,50)
 end = createSprite(950,18,97,160)
...
player.y=530
  ...
  if(player.isTouching(portal2)){
    player.x=100;
    player.y=20
      }
      if(player.isTouching(portal3)){
        player.x=100;
        player.y=300
          }
          if(player.isTouching(portal4)){
            player.x=100;
            player.y=500
              }
...
grp4.visible=false;
              ...
              player.visible=false;
                ...
                textSize(40);
fill("white")
  text("CONGRATS YOUR HOUSE WINS THE HOUSE CUP",10,250)
  fill("blue")
  text("PRESS SPACEBAR TO RESTART",500,100)
  if(keyDown("space")){
    gamestate=0;
  }
              }
  ...
  player.bounceOff(bar21);
  player.bounceOff(bar27);
  player.bounceOff(bar28);
  player.bounceOff(bar29);
  player.bounceOff(bar30);
  player.bounceOff(bar31);
  player.bounceOff(bar32);
  player.bounceOff(bar33);
  player.bounceOff(bar34);
  player.bounceOff(bar35);
  player.bounceOff(bar36);
